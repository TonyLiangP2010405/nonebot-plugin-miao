// 改编自 refs/miao-plugin/models/dmg/AttrItem.js + DmgMastery.js + DmgAttr.js（2026-07 快照）。
// 仅做机械转换：删除 import/export（依赖由 prelude.js/engine.js 以全局注入），
// 不改动任何计算逻辑，保证与原版数值一致。请勿手工润色，更新时重新生成。
class AttrItem {
  constructor (ds) {
